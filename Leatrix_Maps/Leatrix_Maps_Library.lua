...
--[[
----------------------------------------------------------------------
-- L14: LibDBIcon: LibDBIcon  (removed — using external LibDBIcon-1.0)
----------------------------------------------------------------------
...
local function createButton(name, object, db, customCompartmentIcon)
	...
	-- SetFixedFrameStrata/SetFixedFrameLevel do not exist in 3.3.5a
	...
	-- SetFromAlpha/SetToAlpha/SetStartDelay/SetToFinalAlpha do not exist in 3.3.5a
