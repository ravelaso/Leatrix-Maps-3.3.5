	...
	----------------------------------------------------------------------
	-- Leatrix Maps FogClear
	-- Reveals zone maps by populating overlay textures for ALL sub-zones,
	-- including undiscovered ones. Adapted from Mapster's FogClear module
	-- by Nevcairiel (h.leppkes@gmail.com).
	----------------------------------------------------------------------

	local void, Leatrix_Maps = ...

	-- Global so Leatrix_Maps.lua can call LeaMapsFC.Setup()
	LeaMapsFC = {}
	...
	-- No AceDB: add metatable so unknown zone keys return {} instead of nil.
	-- This matches Mapster's AceDB ['*']={} wildcard behaviour.
	setmetatable(errata, {
	...
	local function updateOverlayTextures()
		...
		for texName, texID in pairs(overlayMap) do
			...
			-- Create extra named WorldMapOverlay frames when the errata needs more.
			...
			for j = 1, numTexturesTall do
				...
				if j < numTexturesTall then
					...
					tfH = 16
					while tfH < tpH do tfH = tfH * 2 end
				end
				...
				for k = 1, numTexturesWide do
					...
					if k < numTexturesWide then
						...
						tfW = 16
						while tfW < tpW do tfW = tfW * 2 end
					end
		...
		-- Hide any WorldMapOverlay frames this zone doesn't use.
